#!/usr/bin/env python3
"""Validate a staged The planner RGB-D calibration rosbag."""
...
STATE = '/vibe/planner/calibration/state'
LIVE_OBS = '/vibe/planner/observe/observation'
LIVE_IMAGES = (
...
SNAPSHOT_OBS = '/vibe/planner/calibration/observation'
SNAPSHOT_IMAGES = (
