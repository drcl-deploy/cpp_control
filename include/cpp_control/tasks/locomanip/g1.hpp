 ...
 *
 * Locomanip observation (111):
 *  [ang_vel(3), proj_grav(3), cmd_vel(3),
 *   left_hand_pos(3), left_hand_quat(4),
 *   right_hand_pos(3), right_hand_quat(4),
 *   jpos_rel(29), jvel(29), last_act(29), binary_cmd(1)]
 *
 * Subscribes to:
...
protected:
    ...
    // --- Force command (0..1): d-pad up / RT increments by 0.1 (debounced 0.5s); d-pad down / LT zeros ---
    float binary_cmd_ = 0.0f;
    double last_force_inc_time_sec_ = -1.0;
    bool joy_rt_was_pressed_ = false;
